...
var MaterialIcon = function (_a) {
    ...
    return jsx("span", __assign({}, rest, { className: (className !== null && className !== void 0 ? className : "") + " task-material-icons" }, { children: icon }), void 0);
};
