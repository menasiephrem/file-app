...
var styleClass = {
    ...
    label: function (active) {
        return classNames("font-normal text-sm", active ? "text-task-blue" : "text-black");
    },
    badge: function (active) {
        return classNames("text-[8px] px-1 rounded-md ml-auto", active ? "bg-[#269BF7] text-white" : " bg-gray-300");
    },
    file: function (active, isFile) {
        return classNames("flex items-center text-sm pr-3 material-icon-outlined", isFile ? "text-yellow-300" : "text-task-blue");
    },
};
...
var ItemComponent = function (_a) {
    var _b = _a.hasNodes, hasNodes = _b === void 0 ? false : _b, _c = _a.isOpen, isOpen = _c === void 0 ? false : _c, onClick = _a.onClick, toggleNode = _a.toggleNode, active = _a.active, _d = _a.label, label = _d === void 0 ? "unknown" : _d, _e = _a.numbers, numbers = _e === void 0 ? "" : _e, level = _a.level, file = _a.file;
    return (jsxs("li", __assign({ className: styleClass.root(level, active), role: "button", "aria-pressed": active, onClick: onClick }, { children: [hasNodes && (jsx("div", __assign({ className: "flex items-center", onClick: function (e) {
                    ...
                    e.stopPropagation();
                } }, { children: jsx(ToggleIcon, { on: isOpen }, void 0) }), void 0)), !hasNodes && (jsx("span", __assign({ className: "" }, { children: jsx(MaterialIcon, { className: styleClass.file(active !== null && active !== void 0 ? active : false, file), icon: file ? "insert_drive_file" : "folder" }, void 0) }), active ? "1" : "2")), jsx("span", __assign({ className: styleClass.label(false) }, { children: label }), void 0), jsx("span", __assign({ className: styleClass.badge(active) }, { children: numbers }), void 0)] }), void 0));
};
...
var FileSelector = function () {
    return (jsx(TreeMenu, __assign({ data: data, initialActiveKey: "mammal/canidae" // the path to the active node
        , debounceTime: 125 }, { children: function (_a) {
            var items = _a.items;
            return (jsx("div", { children: jsx("ul", { children: items.map(function (_a) {
                        var key = _a.key, props = __rest(_a, ["key"]);
                        return (jsx(ItemComponent, __assign({}, props), key));
                    }) }, void 0) }, void 0));
        } }), void 0));
};

var File = function () {
    return (jsxs("div", __assign({ className: "flex w-[302px] flex-col shadow bg-white task-shadow" }, { children: [jsxs("div", __assign({ className: "flex bg-white justify-between  border-b-[1px] border-gray-300 px-4 py-6" }, { children: [jsx("span", __assign({ className: "text-black flex items-center font-bold text-lg leading-5" }, { children: "Documents" }), void 0), jsxs(Button, __assign({ onClick: console.log }, { children: [jsx(MaterialIcon, { className: "pr-1 text-sm", icon: "add" }, void 0), " New"] }), void 0)] }), void 0), jsx("div", __assign({ className: "px-4 py-3" }, { children: jsx(FileSelector, {}, void 0) }), void 0)] }), void 0));
};
